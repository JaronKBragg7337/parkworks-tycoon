...
const paths: Record<IconName, string> = {
  ...
  pizza: '<path d="M12 3 4.5 18.5a17 17 0 0 0 15 0L12 3Zm-2 8h.01M14 12.5h.01M12 16h.01"/>',
  ...
  train: '<path d="M4 16V8h6l2.5 3.5H19V16H4Zm3-11h3v3H7V5Zm-5 16h20"/><circle cx="8" cy="18" r="1.6"/><circle cx="16" cy="18" r="1.6"/>',
  coaster: '<path d="M2.5 19.5c1.5-9 4.5-13.5 8-13.5 3 0 4.5 3.5 5.5 7.5.7 2.8 1.7 4 3.5 4"/><path d="M6 12.5v7M11 6.5v13M16.5 14v5.5M2 21h20"/><path d="M8.6 3.4h3.6l.5 2.2H8.2l.4-2.2Z"/>',
  ...
  'cash-machine': '<path d="M6 3h12v18H6V3Zm2.5 3h7v4.5h-7V6ZM9 14h6M9 17h3"/>',
  ...
  fountain: '<path d="M4 20h16m-15-4h14l-2 4H7l-2-4Zm3-4h10l-2 3H9l-2-3Zm5-9v9M9 7a3 3 0 0 1 6 0"/>',
  planter: '<path d="M5 13h14l-1.5 7h-11L5 13Zm2 0V9m5 4V7m5 6V9"/><circle cx="7" cy="7.6" r="1.5"/><circle cx="12" cy="5.6" r="1.5"/><circle cx="17" cy="7.6" r="1.5"/>',
